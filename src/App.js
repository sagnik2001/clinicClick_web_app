...
import DocDashboard from "./NewUpdates/Pages/Doctors/Dashboard/index.jsx"
import DoctorProfile from "./NewUpdates/Pages/Doctors/Dashboard/profile.jsx";
      ...
      <PatientInfoContextProvider>
        <DoctorInfoContextProvider>
          ...
          <Routes>
            ...
            <Route
              path="/reset/:verificationtoken/:id"
              element={<ResetPass />}
            />
            <Route
              path="/doctorDetails"
